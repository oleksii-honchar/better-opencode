...
## Runtime Dependencies — Bun

The project specifies `"packageManager": "bun@1.3.13"` in `package.json`. Install the exact version on macOS:

```bash
# 1. Install bun (latest)
curl -fsSL https://bun.sh/install | bash

# 2. Install the specific version
bunvm install 1.3.13

# 3. Set it as default for this project

      ...
      function* (sessionID: SessionID) {
        ...
        while (true) {
          ...
          if (
            ...
            const stoppingResultWithMessage = stoppingResult as { stop: boolean; message?: string }

            if (stoppingResultWithMessage.stop === false) {
              // Guard: enforce message requirement
              if (!stoppingResultWithMessage.message) {
                yield* slog.warn(
              ...
              yield* flushInjectedMessages({
                injected: [{ role: "system", text: stoppingResultWithMessage.message }],
                sessionID,
                agent: lastUser.agent,
              ...
              yield* slog.info("session.stopping hook prevented exit", {
                continuation: stoppingContinuationCount,
                maxContinuations: maxStoppingContinuations,
              })
              continue
            }
